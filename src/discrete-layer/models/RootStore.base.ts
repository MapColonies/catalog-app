...
export type IngestionRasterData = {
  ...
  partsData: PolygonPartRecordInput[]
  type: RecordType
}
...
export type PolygonPartRecordInput = {
  // partId: string --> will not be generated by code-generator currently remarked in BFF
  // productId: string --> will not be generated by code-generator currently remarked in BFF
  sourceId?: string
  sourceName: string
  description?: string
