...
export const RootStoreBase = withTypedRefs<Refs>()(MSTGQLStore
  ...
  .actions(self => ({
    ...
    queryGetRasterBackupOuterPerimeter(variables: { data: RasterBackupParams }, resultSelector: string | ((qb: GetFeatureModelSelector) => GetFeatureModelSelector) = getFeatureModelPrimitives.toString(), options: QueryOptions = {}) {
      return self.query<{ getRasterBackupOuterPerimeter: GetFeatureModelType }>(`query getRasterBackupOuterPerimeter($data: RasterBackupParams!) { getRasterBackupOuterPerimeter(data: $data) {
        ${typeof resultSelector === "function" ? resultSelector(new GetFeatureModelSelector()).toString() : resultSelector}
      } }`, variables, options)
    },
