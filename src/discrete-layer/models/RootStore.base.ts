...
import { CswCatalogsModel, CswCatalogsModelType } from "./CswCatalogsModel"
import { cswCatalogsModelPrimitives, CswCatalogsModelSelector } from "./CswCatalogsModel.base"
...
import { ShapeMappingModel, ShapeMappingModelType } from "./ShapeMappingModel"
import { shapeMappingModelPrimitives, ShapeMappingModelSelector } from "./ShapeMappingModel.base"
...
export type GetLookupTablesParams = {
  lookupFields?: LookupTableFieldInput[] | null
}
export type LookupTableFieldInput = {
  lookupTable?: (string | null)
  lookupExcludeFields?: (string | null)
}
export type ExplorerGetByPath = {
  path: string
  type: RecordType
  rasterIngestionFilesTypeConfig?: (RasterIngestionFilesTypeConfig | null)
}
...
export type WfsPolygonPartsGetFeatureParams = {
  ...
  dWithin?: (number | null)
  filterProperties?: WfsFilterPropertyParam[] | null
}
...
export type LayerRasterRecordInput = {
  ...
  srs: string
  producerName: string
  // creationDateUTC?: any --> will not be generated by code-generator currently remarked in BFF
  // ingestionDate?: any --> will not be generated by code-generator currently remarked in BFF
  // updateDateUTC?: any --> will not be generated by code-generator currently remarked in BFF
  // imagingTimeBeginUTC: any --> will not be generated by code-generator currently remarked in BFF
  // imagingTimeEndUTC: any --> will not be generated by code-generator currently remarked in BFF
  // maxHorizontalAccuracyCE90: number --> will not be generated by code-generator currently remarked in BFF
  // minHorizontalAccuracyCE90?: number --> will not be generated by code-generator currently remarked in BFF
  // sensors: string[] --> will not be generated by code-generator currently remarked in BFF
  region: string[]
  ...
  srsName: string
  // maxResolutionDeg?: number --> will not be generated by code-generator currently remarked in BFF
  // minResolutionDeg: number --> will not be generated by code-generator currently remarked in BFF
  // maxResolutionMeter?: number --> will not be generated by code-generator currently remarked in BFF
  // minResolutionMeter: number --> will not be generated by code-generator currently remarked in BFF
  rms?: (number | null)
  scale?: (number | null)
  // footprint: any --> will not be generated by code-generator currently remarked in BFF
  productBoundingBox?: (string | null)
  productStatus?: (RecordStatus | null)
...
export type Layer3DRecordInput = {
  ...
  sourceDateStart: any
  sourceDateEnd: any
  minResolutionMeter?: (number | null)
  maxResolutionMeter?: (number | null)
  maxAccuracyCE90: number
  absoluteAccuracyLE90: number
  accuracySE90?: (number | null)
  relativeAccuracySE90?: (number | null)
  visualAccuracy?: (number | null)
  sensors: string[]
  footprint: any
  heightRangeFrom?: (number | null)
  heightRangeTo?: (number | null)
  srsId: string
  srsName: string
  region: string[]
  classification: string
  ...
  producerName: string
  minFlightAlt?: (number | null)
  maxFlightAlt?: (number | null)
...
export type LayerDemRecordInput = {
  ...
  relativeAccuracyLEP90?: (number | null)
  resolutionDegree?: (number | null)
  resolutionMeter: number
  imagingSortieAccuracyCEP90?: (number | null)
  layerPolygonParts?: (any | null)
  productBoundingBox?: (string | null)
  heightRangeFrom?: (number | null)
  heightRangeTo?: (number | null)
  geographicArea?: (string | null)
...
export type RecordDelete3D = {
  id: string
  type: RecordType
}
export type RecordDeleteRaster = {
  id: string
  type: RecordType
  approverName: string
  approvalCode: string
...
queryGetRasterBackupOuterPerimeter="queryGetRasterBackupOuterPerimeter",
...
export const RootStoreBase = withTypedRefs<Refs>()(MSTGQLStore
  ...
  .actions(self => ({
    ...
    querySearch(variables: { resultType?: (ResultType | null), end?: (number | null), start?: (number | null), opts?: (SearchOptions | null) }, resultSelector: string | ((qb: CswCatalogsModelSelector) => CswCatalogsModelSelector) = cswCatalogsModelPrimitives.toString(), options: QueryOptions = {}) {
    ...
    queryJobs(variables: { params?: (JobsSearchParams | null) }, resultSelector: string | ((qb: JobModelSelector) => JobModelSelector) = jobModelPrimitives.toString(), options: QueryOptions = {}) {
    ...
    queryTasks(variables: { params?: (TasksSearchParams | null) }, resultSelector: string | ((qb: TasksGroupModelSelector) => TasksGroupModelSelector) = tasksGroupModelPrimitives.toString(), options: QueryOptions = {}) {
    ...
    queryGetRasterBackupOuterPerimeter(variables: { data: RasterBackupParams }, resultSelector: string | ((qb: GeojsonFeatureCollectionModelSelector) => GeojsonFeatureCollectionModelSelector) = geojsonFeatureCollectionModelPrimitives.toString(), options: QueryOptions = {}) {
      return self.query<{ getRasterBackupOuterPerimeter: GeojsonFeatureCollectionModelType }>(`query getRasterBackupOuterPerimeter($data: RasterBackupParams!) { getRasterBackupOuterPerimeter(data: $data) {
    ...
    mutateStartRasterIngestion(variables: { data: IngestionRasterData }, resultSelector: string | ((qb: RasterIngestionModelSelector) => RasterIngestionModelSelector) = rasterIngestionModelPrimitives.toString(), optimisticUpdate?: () => void) {
      return self.mutate<{ startRasterIngestion: RasterIngestionModelType }>(`mutation startRasterIngestion($data: IngestionRasterData!) { startRasterIngestion(data: $data) {
        ${typeof resultSelector === "function" ? resultSelector(new RasterIngestionModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    mutateStartRasterUpdateGeopkg(variables: { data: IngestionRasterData }, resultSelector: string | ((qb: RasterIngestionModelSelector) => RasterIngestionModelSelector) = rasterIngestionModelPrimitives.toString(), optimisticUpdate?: () => void) {
      return self.mutate<{ startRasterUpdateGeopkg: RasterIngestionModelType }>(`mutation startRasterUpdateGeopkg($data: IngestionRasterData!) { startRasterUpdateGeopkg(data: $data) {
        ${typeof resultSelector === "function" ? resultSelector(new RasterIngestionModelSelector()).toString() : resultSelector}
      } }`, variables, optimisticUpdate)
    },
    ...
    mutateDelete3DLayer(variables: { data: RecordDelete3D }, optimisticUpdate?: () => void) {
      return self.mutate<{ delete3DLayer: string }>(`mutation delete3DLayer($data: RecordDelete3D!) { delete3DLayer(data: $data) }`, variables, optimisticUpdate)
    },
    mutateDeleteRasterLayer(variables: { data: RecordDeleteRaster }, optimisticUpdate?: () => void) {
      return self.mutate<{ deleteRasterLayer: string }>(`mutation deleteRasterLayer($data: RecordDeleteRaster!) { deleteRasterLayer(data: $data) }`, variables, optimisticUpdate)
    },
