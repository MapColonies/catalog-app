...
import { IBaseMaps } from '@map-colonies/react-components';
...
const INITIAL_STATE = {
  ...
  tabViews: [{idx: TabViews.CATALOG}, {idx: TabViews.SEARCH_RESULTS}, {idx: TabViews.EXPORT_LAYER}, {idx: TabViews.BASEMAPS}],
  entityDescriptors: [],
