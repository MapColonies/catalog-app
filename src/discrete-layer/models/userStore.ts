...
export enum UserAction {
  ...
  ENTITY_ACTION_SELECTED_ENTITY_EDIT = 'entity_action.selected.edit',
  ENTITY_ACTION_SELECTED_ENTITY_VIEW = 'entity_action.selected.view',
  ENTITY_ACTION_LAYERRASTERRECORD_UPDATE = 'entity_action.LayerRasterRecord.update',
  ENTITY_ACTION_LAYERRASTERRECORD_MANAGELINKS = 'entity_action.LayerRasterRecord.manageLinks',
  ENTITY_ACTION_LAYER3DRECORD_MANAGELINKS = 'entity_action.Layer3DRecord.manageLinks',
  ENTITY_ACTION_LAYERRASTERRECORD_REVERT = 'entity_action.LayerRasterRecord.revert',
  ...
  ENTITY_ACTION_LAYERDEMRECORD_VIEWER = 'entity_action.LayerDemRecord.viewer',
  ENTITY_ACTION_VECTORBESTRECORD_VIEWER = 'entity_action.VectorBestRecord.viewer',
  ENTITY_ACTION_QUANTIZEDMESHBESTRECORD_VIEWER = 'entity_action.QuantizedMeshBestRecord.viewer',
  ...
  SYSTEM_CALLBACK_3D_DELETE = 'system_callback.3d_delete',
  SYSTEM_CALLBACK_RASTER_REVERT = 'system_callback.raster_revert',
  SYSTEM_CALLBACK_RASTER_DELETE = 'system_callback.raster_delete',
...
const ROLES: IRole[] = [
  {
    ...
    permissions: {
      ...
      [UserAction.ENTITY_ACTION_LAYERRASTERRECORD_MANAGELINKS]: {enabled: true},
      [UserAction.ENTITY_ACTION_LAYER3DRECORD_MANAGELINKS]: {enabled: true},
      [UserAction.ENTITY_ACTION_LAYERRASTERRECORD_REVERT]: {enabled: true},
      ...
      [UserAction.ENTITY_ACTION_LAYERDEMRECORD_VIEWER]: {enabled: false},
      [UserAction.ENTITY_ACTION_VECTORBESTRECORD_VIEWER]: {enabled: false},
      [UserAction.ENTITY_ACTION_QUANTIZEDMESHBESTRECORD_VIEWER]: {enabled: false},
  ...
  },
  {
    ...
    permissions: {
      ...
      [UserAction.ENTITY_ACTION_LAYERRASTERRECORD_MANAGELINKS]: {enabled: false},
      [UserAction.ENTITY_ACTION_LAYER3DRECORD_MANAGELINKS]: {enabled: false},
      [UserAction.ENTITY_ACTION_LAYERRASTERRECORD_REVERT]: {enabled: false},
