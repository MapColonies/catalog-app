...
const InnerForm = (props: LayerDetailsFormCustomProps & FormikProps<FormValues>): JSX.Element => {
  const {
    errors,
    values,
    dirty,
  ...
  const reloadFormMetadata = (ingestionFields: FormValues, metadata: MetadataFile): void => {
