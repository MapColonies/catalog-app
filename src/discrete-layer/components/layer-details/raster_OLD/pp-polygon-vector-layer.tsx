...
export const PolygonPartsByPolygonVectorLayer: React.FC<PolygonPartsVectorLayerProps> = observer(
            ...
            for (let i = 0; i < existingPolygonParts.length; i++) {
              ...
              try {
                if (bufferedPart) {
                  ...
                  if (
                    intersection &&
                    ingestionResolutionMeter > existingPart.properties?.resolutionMeter
                  ) {
