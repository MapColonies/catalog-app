...
const getFeatureAndMarker = (geometry: Geometry, featureFeatureType: FeatureType, markerFeatureType: FeatureType): { feature: Feature, marker: Feature } => {
  const feature = {
    type: 'Feature',
    properties: {
