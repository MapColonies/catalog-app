...
const setDefaultValues = (
  ...
  getFlatEntityDescriptors(record['__typename'] as LayerRecordTypes, descriptors)
    .filter((field) => field.default)
    .forEach((descriptor) => (record[descriptor.fieldName as string] = descriptor.default));
};
...
export const EntityDialog: React.FC<EntityDialogProps> = observer((props: EntityDialogProps) => {
  ...
  useEffect(() => {
    ...
    const desc = [...ingestionFields, ...descriptors].map((field: FieldConfigModelType) => {
      return {
        ...field,
