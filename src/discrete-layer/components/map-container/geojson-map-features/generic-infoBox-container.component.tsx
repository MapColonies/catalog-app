...
const GenericInfoBoxContainer: React.FC<PropsWithChildren<{ positionInRadians?: IPosition }>> = ({
  positionInRadians,
  children,
}) => {
  ...
  return (
    <>
      ...
      >
        <CreateSvgIconLocationOn
          className="glow-missing-icon"
          style={{ stroke: 'currentColor', fill: 'currentColor', transform: 'scale(0.5)' }}
          height="48"
          width="48"
        />
        {getCoordinatesDisplayText(
          CesiumMath.toDegrees(positionInRadians.latitude),
          CesiumMath.toDegrees(positionInRadians.longitude)
        )}
      </Typography>
      {children}
    </>
