          ...
          RecordType.RECORD_RASTER,
          {
            ...
            maxResolutionDeg: {
              ...
              rhfValidation: {
                ...
                required: {
                  value: true,
                  message: intl.formatMessage({ id: 'export-layer.validations.required' }),
                },
              },
            },
            minResolutionDeg: {
              ...
              validationAgainstField: {
                ...
                validate: (minResolutionValue, maxResolutionValue): string | undefined => {
                  ...
                  const validationErrorMsg = intl.formatMessage(
                    ...
                    { relation: validationRelationText, fieldName: maxResDegFieldName }
                  );
    ...
    for (const [fieldName, fieldOptions] of Object.entries(propsForDomain ?? {})) {
      if (predicate(fieldOptions)) {
        let fieldValue =
          ...
          (get(layerToExport, fieldOptions.defaultsFromEntityField as string) as
            | string
            | undefined) ??
          '';
