import { CesiumGeographicTilingScheme, Proj, IRasterLayer, IBaseMaps, IBaseMap } from '@map-colonies/react-components';
...
const APP_CONFIG = {
  ...
  RUNNING_MODE: {
    ...
    CSW_DEFAULT_PAGE_SIZE: RUNNING_MODE.cswDefaultPageSize,
  },
  ...
  CONTEXT_MENUS: {
    MAP: {
      ...
      POLYGON_PARTS_FEATURE_CONFIG: {
        color: `${POLYGON_PARTS.highResolutionColor}30`, //'#00FF0030',
